...
<?php if (!Omeka_Captcha::isConfigured()): ?>
    <p class="alert">
		<?php echo __('You have not entered your <a href="http://www.google.com/recaptcha/intro/index.html/">reCAPTCHA</a> API keys under <a href="<?php echo url(\'settings/edit-security#fieldset-captcha\'); ?>">security settings</a>. We recommend adding these keys, or the contact form will be vulnerable to spam.') ?>
	</p>
<?php endif; ?>
