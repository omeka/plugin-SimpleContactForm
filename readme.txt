...
1. Unzip the plugin and add it to your plugins directory.
2. Login as an admin, and go to Settings->Plugins.
3. Install the SimpleContactForm plugin.
4. Click on the Configure link next to SimpleContactForm plugin.
5. Choose your Forward-To email address. If blank, you will not be forwarded
messages from your users.
6. Choose your Reply-From email address, the address that users can reply to. If blank, your users will not be sent confirmation emails of their submissions.
7. Choose your Relative Page Path.  For example, suppose you want your omeka
